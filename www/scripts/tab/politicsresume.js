$(function () {
    ...
    function loadD() {
        if (memberInfo != null) {
            if (memberInfo.politicsResume != null) {
                $dataGrid.datagrid('loadData', memberInfo.politicsResume);
            } else {
    ...
    $('#politics-resume').click(function () {
        window.addEventListener("grid-row-selection", function (event) {
            memberInfo = event.detail;
            loadD()
        });
    ...
    function save() {
        ...
        if (endEditing()) {
            memberInfo.politicsResume = $dataGrid.datagrid('getRows');
            $.ajax({
